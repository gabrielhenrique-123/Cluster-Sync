...
if __name__ == "__main__":
    ...
    threading.Thread(target=cluster_sync_server, args=("127.0.0.1", 5001, node_id)).start()
    threading.Thread(target=node_sync_server, args=("127.0.0.1", 6001, node_id)).start()
