...
if __name__ == "__main__":
    ...
    threading.Thread(target=cluster_sync_server, args=("127.0.0.1", 5002, node_id)).start()
    threading.Thread(target=node_sync_server, args=("127.0.0.1", 6002, node_id)).start()
