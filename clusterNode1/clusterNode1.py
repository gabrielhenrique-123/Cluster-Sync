...
if __name__ == "__main__":
    node_id = 1  # Definido como o nó 1
    threading.Thread(target=cluster_sync_server, args=("cluster_node_1", 5001, node_id)).start()
    threading.Thread(target=node_sync_server, args=("cluster_node_1", 6001, node_id)).start()
