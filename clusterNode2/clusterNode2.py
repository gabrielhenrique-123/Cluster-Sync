...
if __name__ == "__main__":
    node_id = 2  # Definido como o nó 1
    threading.Thread(target=cluster_sync_server, args=("cluster_node_2", 5002, node_id)).start()
    threading.Thread(target=node_sync_server, args=("cluster_node_2", 6002, node_id)).start()
