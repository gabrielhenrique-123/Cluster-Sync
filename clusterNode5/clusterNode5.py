...
if __name__ == "__main__":
    ...
    threading.Thread(target=cluster_sync_server, args=("cluster_node_5", 5005, node_id)).start()
    threading.Thread(target=node_sync_server, args=("cluster_node_5", 6005, node_id)).start()
