...
cluster_nodes = [
    ...
    ("cluster_node_2", 5002),  # Nó 2 (nome do serviço com porta 5003)
    ("cluster_node_3", 5003),  # Nó 3 (nome do serviço com porta 5004)
    ("cluster_node_5", 5005),  # Nó 5 (nome do serviço com porta 5005)
    # Este código será executado no Nó 4 (porta 5004)
]
...
if __name__ == "__main__":
    ...
    local_node_id = 4  # Este script representa o nó 1
    host = "0.0.0.0"  # IP do servidor (aceita conexões de todas as interfaces)
    port = 5004  # Porta do servidor para o nó 1
