...
if __name__ == "__main__":
    ...
    # Iniciar o servidor do Cluster Sync (porta 5005) e o ouvidor (porta 6005) em threads separadas
    threading.Thread(target=cluster_sync_server, args=("127.0.0.1", 5005, local_node_id)).start()
    threading.Thread(target=node_listener, args=("127.0.0.1", 6005)).start()
