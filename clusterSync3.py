...
if __name__ == "__main__":
    local_node_id = "Peer3"  # ID único deste nó
    # Iniciar o servidor do Cluster Sync (porta 5003) e o ouvidor (porta 6003) em threads separadas
    threading.Thread(target=cluster_sync_server, args=("127.0.0.1", 5003, local_node_id)).start()
    threading.Thread(target=node_listener, args=("127.0.0.1", 6003)).start()
